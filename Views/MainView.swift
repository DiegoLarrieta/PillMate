...
struct MainView: View {
    ...
    @State private var medicationName: String = "" // Name of the medication
    @State private var dosage: String = "" // Dosage of the medication
    @State private var frequency: String = "" // Frequency of the medication
        ...
        var body: some View {
            NavigationView {
                ZStack(alignment: .topTrailing) {
                    ...
                    if isCameraVisible {
                        CameraView(capturedImage: $capturedImage, medicationName: $medicationName, dosage: $dosage, frequency: $frequency, duration: $duration)
